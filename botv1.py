...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    msg = """👋 <b>Chào Mừng Bạn Đến Với Tools Dự Đoán Tài Xỉu V1</b>
✨ By <b>HoangPhu</b> Or <b>GiaHuy</b>

⚠️ <b>Lưu Ý:</b> Tools V1 hiện tại có <b>tỉ lệ dự đoán ~72%</b> nếu dữ liệu học máy đủ tốt 📊

📬 <b>Anh Em Muốn Nâng Tools Để Tăng Tỉ Lệ Chính Xác</b>  
👉 Inbox Zalo: <b>0818540840</b> 📲

🧠 Gửi mã MD5 để bot dự đoán <b>Tài (1)</b> / <b>Xỉu (0)</b>  
📥 Gửi <b>0</b> hoặc <b>1</b> để xác nhận kết quả thực tế

🔥 Chúc anh em đỏ như son 🍀"""
...
if __name__ == '__main__':
    app = ApplicationBuilder().token("8092431132:AAFhGw_grK52OC8VeQg63uDgjvn92ifNCU0").build()
    ...
    print("🤖 Bot đang chạy...")# ========== Webhook FastAPI ==========
...
@webapi.get("/")
def root():
    return {"status": "Bot is alive (Webhook ready)"}

if __name__ == "__main__":
    import uvicorn
    port = int(os.environ.get("PORT", 10000))
    uvicorn.run(webapi, host="0.0.0.0", port=port)